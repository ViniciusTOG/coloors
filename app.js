...
const closeAdjustments = document.querySelectorAll(".close-adjustament");
...
function lockAdjustment(index) {
  const lockedColorDiv = colorDivs[index];
  lockedColorDiv.classList.toggle("locked");
  if (lockedColorDiv.classList.contains("locked")) {
...
const deleteLibraryBtn = document.querySelector(".delete-library");
...
deleteLibraryBtn.addEventListener("click", removeLibrary);
//functions
...
function removeLibrary() {
  const libraries = document.querySelectorAll(".custom-palette");
  closeLibrary();
  savedPalettes = [];
